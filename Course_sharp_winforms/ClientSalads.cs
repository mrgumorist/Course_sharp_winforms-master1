...
{
    public partial class ClientSalads : Form
    {
        public User UserTemp;
        public ClientSalads(User user)
        {
            InitializeComponent();
            UserTemp = user;
        }
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            UserTemp.listOfTempBuying.Add($"CheekenSalad 3$ count {total / Helper.PriceOfSalad1}");
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            UserTemp.TotalPrice += total;
            UserTemp.listOfTempBuying.Add($"BaconSalad 4$ count {total / Helper.PriceOfSalad2}");
        }

        private void ClientSalads_KeyDown(object sender, KeyEventArgs e)
        {

...
namespace Course_sharp_winforms
{
    public partial class SnackForm : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            UserTemp.listOfTempBuying.Add($"Freee 3$ count {total / Helper.PriceOfSalad1}");
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            total *= Helper.PriceOfSalad1;
            UserTemp.TotalPrice += total;
            UserTemp.listOfTempBuying.Add($"Yougurt 3$ count {total/ Helper.PriceOfSalad1}");
        }

        private void SnackForm_KeyDown(object sender, KeyEventArgs e)
        {
